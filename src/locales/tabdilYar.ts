...
export const fa = {
	...
	moneyReceivedInputAmountConfirmationMessage:
		"آیا مبلغ *{0}* ریال دریافت کرده‌اید؟ لطفاً از صحیح بودن مبلغ اطمینان حاصل کنید.\n\nاگر مبلغ واریزی صحیح است، لطفاً `تأیید` را در چت ارسال کنید. در غیر این صورت، لطفاً مبلغ واریزی توسط خریدار را وارد کنید.",
	moneyReceivedConfirmPartnerMessage:
	...
	adminEuroReceivedEuroPartnerMessage:
		"با تشکر، ما *{0} یورو* دریافت کرده ایم\\!\n\nدر قدم بعدی، خریدار مبلغ*{1} ریال* را به حساب بانکی ایرانی شما ارسال خواهد کرد\\. لطفاً حساب بانکی خود را به‌طور منظم بررسی کنید و به محض اطمینان از دریافت معادل ریالی، دکمه زیر را بفشارید\\.",
